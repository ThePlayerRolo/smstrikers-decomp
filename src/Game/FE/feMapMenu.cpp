 ...
 */
void FEMapMenu::ChangeItem(int, TLInstance*)
{
}
 ...
 */
void FEMapMenu::IsItemActive(int) const
{
}
 ...
 */
void FEMapMenu::IsSelectedItemActive() const
{
}
 ...
 */
void FEMapMenu::GetSelectedItem() const
{
}
