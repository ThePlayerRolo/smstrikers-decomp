...
int DVDCompareDiskID(const DVDDiskID* id1, const DVDDiskID* id2)
{
    ...
    ASSERTMSGLINE(81, diskNum1 == 0xFF || ((diskNum1 / 16) < 10 && diskNum1 % 16 < 10),
                  "DVDCompareDiskID(): Specified disk number for id1 is neither 0xff nor a BCD number");
    ASSERTMSGLINE(82, version1 == 0xFF || ((version1 / 16) < 10 && version1 % 16 < 10),
                  "DVDCompareDiskID(): Specified version number for id1 is neither 0xff nor a BCD number");
    ...
    ASSERTMSGLINE(88, diskNum2 == 0xFF || ((diskNum2 / 16) < 10 && diskNum2 % 16 < 10),
                  "DVDCompareDiskID(): Specified disk number for id2 is neither 0xff nor a BCD number");
    ASSERTMSGLINE(89, version2 == 0xFF || ((version2 / 16) < 10 && version2 % 16 < 10),
                  "DVDCompareDiskID(): Specified version number for id2 is neither 0xff nor a BCD number");
#endif
...
DVDDiskID* DVDGenerateDiskID(DVDDiskID* id, const char* game, const char* company, u8 diskNum, u8 version)
{
    ...
    ASSERTMSGLINE(124, game == NULL || strlen(game) == 4,
                  "DVDGenerateDiskID(): Specified game name is neither NULL nor 4 character long\n");
    ...
    ASSERTMSGLINE(127, diskNum == 0xFF || ((diskNum / 16) < 10 && diskNum % 16 < 10),
                  "DVDGenerateDiskID(): Specified disk number is neither 0xff nor a BCD number");
    ASSERTMSGLINE(128, version == 0xFF || ((version / 16) < 10 && version % 16 < 10),
                  "DVDGenerateDiskID(): Specified version number is neither 0xff nor a BCD number");
