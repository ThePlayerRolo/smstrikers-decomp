...
config.libs = [
    ...
    RuntimeLib_MSL_C(
        ...
        [
            ...
            # Object(NonMatching, "PowerPC_EABI_Support/MSL/MSL_C/MSL_Common/uart_console_io.c"),
            ...
            Object(NonMatching, "PowerPC_EABI_Support/MSL/MSL_C/PPC_EABI/critical_regions.gamecube.c"),
        ],
    ),
    GameLib(
